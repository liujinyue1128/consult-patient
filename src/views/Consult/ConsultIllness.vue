...
import { uploadImage } from '@/services/consult.ts'
...
const uploadSuccess = (image: Image) => {
  form.value.pictures?.push(image)
}
const deleteSuccess = (item: UploaderFileListItem) => {
...
<template>
  <div class="consult-illness-page">
    ...
    <van-button type="primary" :class="{ disabled }" @click="next">下一步</van-button>
  </div>
</template>
